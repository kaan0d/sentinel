...
I developed this project with Python 3.13. It should also work on Python 3.12 and newer (3.12 is the minimum in `pyproject.toml`), and you are welcome to try it there.
